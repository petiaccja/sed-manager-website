---
description: Learn about the theory of encrypting digital data. This article serves as an overview to the technology that powers self-encrypting drives.
---
...
![Symmetric encryption process](/img/illustrations/docs/theory/symmetric_encryption_light.svg#gh-light-mode-only)
![Symmetric encryption process](/img/illustrations/docs/theory/symmetric_encryption_dark.svg#gh-dark-mode-only)
...
![Block cipher](/img/illustrations/docs/theory/block_cipher_light.svg#gh-light-mode-only)
![Block cipher](/img/illustrations/docs/theory/block_cipher_dark.svg#gh-dark-mode-only)
...
![Encryption points](/img/illustrations/docs/theory/encryption_points_light.svg#gh-light-mode-only)
![Encryption points](/img/illustrations/docs/theory/encryption_points_dark.svg#gh-dark-mode-only)
