...
These four SSCs are rather similar, and have the following organization:
...
The main difference between them is the different number of User and Admin authorities they support, and how they handle encryption.
