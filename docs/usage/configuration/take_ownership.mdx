...
The [owner authority](/docs/theory/the_tcg_spec#the-opal-opalite-pyrite-and-ruby-sscs) comes with a factory-configured default password. Taking ownership of the device is a single step to change the owner's password to something only you know.
...
:::info PSID revert & lost password
...
:::warning Losing all passwords = bricked device
