...
The [owner authority](../..//overview/tcg_specs.mdx#authorities) comes with a factory-configured default password. Taking ownership of the device is a single step to change the owner's password to something only you know.
