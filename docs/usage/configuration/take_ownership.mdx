...
The [owner authority](/docs/overview/the_tcg_spec#the-opal-opalite-pyrite-and-ruby-sscs) comes with a factory-configured default password. Taking ownership of the device is a single step to change the owner's password to something only you know.
