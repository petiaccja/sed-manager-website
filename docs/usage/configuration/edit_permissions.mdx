...
- **Unshadow MBR**: When checked, the user can [unshadow the MBR](../../overview/tcg_specs.mdx#booting-from-encrypted-drives), revealing the (still encrypted) contents of the drive.
