...
[MBR shadowing](/docs/overview/the_tcg_spec#mbr-shadowing) is disabled by default, even if the device supports it. If shadowing is enabled, power cycling the device will make it show the shadow MBR instead of the actual disk.
