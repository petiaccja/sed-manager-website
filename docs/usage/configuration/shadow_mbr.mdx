...
[MBR shadowing](../../overview/tcg_specs.mdx#booting-from-encrypted-drives) is disabled by default, even if the device supports it. If shadowing is enabled, power cycling the device will make it show the shadow MBR instead of the actual disk.
